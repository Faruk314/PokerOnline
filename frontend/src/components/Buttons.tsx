    ...
    <div className="flex gap-4 w-[480px]">
      ...
      {!canCheck ? (
         <button
          ...
          className="relative group px-8 py-5 rounded-xl text-white text-base font-bold tracking-wider transition-all duration-300 overflow-hidden bg-gradient-to-r from-blue-600 to-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] hover:scale-105 flex-1 h-[80px] flex items-center justify-center"
        >
         ...
         <button
          ...
          className="relative group px-8 py-5 rounded-xl text-white text-base font-bold tracking-wider transition-all duration-300 overflow-hidden bg-gradient-to-r from-gray-600 to-gray-500 shadow-[0_0_20px_rgba(107,114,128,0.3)] hover:shadow-[0_0_30px_rgba(107,114,128,0.5)] hover:scale-105 flex-1 h-[80px] flex items-center justify-center"
        >
