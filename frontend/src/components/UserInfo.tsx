      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-3 bg-gradient-to-r from-gray-900/80 to-gray-950/80 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-2 shadow-lg">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-white">{totalCoins?.toLocaleString()}</span>
            <span className="text-sm text-gray-400">CHIPS</span>
          </div>
          <div className="ml-2 text-xs bg-gradient-to-r from-green-500 to-emerald-600 text-white px-2 py-1 rounded-full animate-pulse">
            LIVE
          </div>
        </div>
      </div>
