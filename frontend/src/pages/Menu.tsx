...
const Menu = () => {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col items-center justify-start md:justify-center pt-24 md:pt-0 pb-12 bg-gradient-to-b from-gray-950 via-gray-900 to-black overflow-y-auto overflow-x-hidden relative">
      ...
      <div className="absolute top-0 left-0 right-0 z-50 px-3 py-2 md:px-6 md:py-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="relative group bg-gradient-to-r from-gray-900/80 to-gray-950/80 backdrop-blur-xl border border-white/10 rounded-xl p-2 md:p-3 hover:scale-110 transition-all duration-300 shadow-2xl"
          >
      ...
      <div className="relative z-10 w-full max-w-4xl px-4">
        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-b from-gray-900/50 to-gray-950/50 backdrop-blur-xl rounded-2xl border border-white/10 p-4 md:p-8 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="group">
                <button
                  ...
                  className="relative w-full h-40 md:h-48 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 hover:border-yellow-500/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 shadow-2xl overflow-hidden"
                >
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4 md:p-6">
                    <div className="relative mb-2 md:mb-6">
                      ...
                      <img
                        src={pokerLogo}
                        className="relative top-1 md:top-3 h-10 w-10 md:h-12 md:w-12 drop-shadow-2xl animate-pulse"
                        alt="Poker Logo"
                      />
                    </div>
              ...
              <div className="group">
                <button
                  ...
                  className="relative w-full h-40 md:h-48 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 hover:border-blue-500/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 shadow-2xl overflow-hidden"
                >
              ...
              <div className="group">
                <button
                  ...
                  className="relative w-full h-40 md:h-48 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 hover:border-green-500/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 shadow-2xl overflow-hidden"
                >
              ...
              <div className="group">
                <button
                  onClick={handleExit}
                  className="relative w-full h-40 md:h-48 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-white/10 hover:border-red-500/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 shadow-2xl overflow-hidden"
                >
                  ...
                  <div className="relative h-full flex flex-col items-center justify-center p-4 md:p-6">
                    <div className="mb-2 md:mb-4 text-4xl md:text-5xl">
